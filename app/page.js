...
import { Mail, Linkedin, Github, ExternalLink, Menu, X, ChevronDown, MapPin, Calendar, Award, Code, Brain, BarChart3, Globe, Settings } from 'lucide-react';
...
const portfolioData = {
  ...
  contact: {
    ...
    linkedin: "https://www.linkedin.com/in/shanmukh-venkata-nutulapati-84578126a/",
  },
  education: {
  ...
  achievements: [
    "Published research in medical image analysis and pattern recognition",
  ...
  projects: [
    {
      ...
      description: "A machine learning model that predicts movie box office revenue using metadata sourced from TMDB. The project includes full preprocessing, feature engineering, and deployment using Flask.",
    ...
    },
    {
      ...
      description: "A fake news classifier built with BERT and enhanced using SHAP explainability. It highlights the specific parts of an article influencing the model's decisions, offering transparency and trustworthiness for end users.",
    ...
    },
    {
      ...
      description: "A hybrid web threat detection system combining machine learning and deep learning to identify phishing, malware, and other threats. Features include robust preprocessing and a Random Forest classifier.",
    ...
    },
    {
      ...
      description: "A pattern recognition pipeline for cancer cell image classification. This project extracts relevant texture and morphological features from histopathological images and trains ML classifiers to detect malignant patterns.",
      tags: ["Python", "OpenCV", "Scikit-learn", "GLCM", "PCA"],
      githubLink: "https://github.com/nvshanmukh/cancer-cell-feature-extraction",
      liveLink: "https://cancer-cell-demo.streamlit.app",
    },
    {
      title: "Supermarket Sales Data Analysis",
      description: "A full-scale exploratory and predictive analysis on supermarket sales data. The project analyzes customer demographics, purchase behavior, and branch performance using visualizations.",
    ...
    },
    {
      ...
      description: "A statistical data analysis project aimed at understanding the demographics, symptoms, and treatment trends of OCD. It uses visual analytics to identify key patterns and relationships in a medical dataset.",
    ...
    >
      <div className="flex-grow">
        <div className="flex items-center justify-between mb-2">
          ...
          <span className="text-xs text-cyan-400 bg-cyan-400/10 px-2 py-1 rounded-full">{project.category}</span>
        </div>
        <p className="text-gray-400 mb-4 text-sm leading-relaxed">{project.description}</p>
        <div className="flex flex-wrap gap-2 mb-4">
          {project.tags.map(tag => (
            <span key={tag} className="bg-gray-700 text-cyan-300 text-xs font-medium px-2.5 py-1 rounded-full hover:bg-cyan-400/20 transition-colors duration-300">{tag}</span>
          ))}
        </div>
      </div>
      <div className="flex items-center gap-4 mt-auto pt-4 border-t border-gray-700/50">
        <a href={project.githubLink} target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-cyan-400 transition-all duration-300 flex items-center gap-2 hover:scale-110">
          <Github size={18} />
          <span>GitHub</span>
        </a>
        {project.liveLink && (
          <a href={project.liveLink} target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-cyan-400 transition-all duration-300 flex items-center gap-2 hover:scale-110">
...
const ContactLink = ({ href, icon, text }) => (
  <a href={href} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-lg text-gray-400 hover:text-cyan-400 transition-all duration-300 hover:scale-110 p-3 rounded-lg hover:bg-gray-800/50">
...
const FloatingElements = () => (
  <>
    ...
    <div className="fixed top-1/2 right-8 w-3 h-3 bg-cyan-400/20 rounded-full animate-bounce" style={{ animationDelay: '1s' }} />
    <div className="fixed bottom-1/4 left-1/3 w-1 h-1 bg-cyan-400/40 rounded-full animate-ping" style={{ animationDelay: '2s' }} />
  </>
);
    ...
    <div className="bg-gray-900 min-h-screen text-gray-300 font-sans selection:bg-cyan-500 selection:text-white relative overflow-x-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <header className="flex justify-between items-center py-6 sticky top-0 bg-gray-900/95 backdrop-blur-md z-50 border-b border-gray-800/50">
          <h1 className="text-2xl font-bold text-white tracking-wider hover:text-cyan-400 transition-colors duration-300 cursor-default">
            SHANMUKH
          </h1>
        ...
        <main className="pt-8">
          ...
          <section id="home" className="text-center py-20 md:py-32 flex flex-col items-center">
            ...
            <div className="flex gap-4 mt-8">
              ...
              <a href="#contact" className="border-2 border-cyan-500 text-cyan-500 hover:bg-cyan-500 hover:text-white font-bold py-3 px-8 rounded-lg transition-all duration-300 hover:scale-105">
                Get In Touch
              </a>
            </div>
          </section>
            ...
            <div className="grid md:grid-cols-2 gap-12 max-w-6xl mx-auto">
              <div className="space-y-6">
                <div className="bg-gray-800/50 p-6 rounded-lg border border-gray-700/50">
                  ...
                  <p className="text-gray-300 font-medium">{portfolioData.education.degree}</p>
                  <p className="text-gray-400">{portfolioData.education.institution}</p>
                  <p className="text-gray-400">{portfolioData.education.year}</p>
                </div>
              </div>
              <div className="space-y-6">
                <div className="bg-gray-800/50 p-6 rounded-lg border border-gray-700/50">
                  ...
                  <ul className="space-y-2">
                    {portfolioData.achievements.map((achievement, index) => (
                      <li key={index} className="text-gray-400 flex items-start gap-2">
                        <ChevronDown className="text-cyan-400 mt-1 rotate-[-90deg]" size={16} />
                        {achievement}
                      </li>
                    ))}
                  </ul>
          ...
          <section id="projects" className="py-20">
            ...
            <p className="text-gray-400 text-center mb-12 max-w-2xl mx-auto">
              A collection of data science and machine learning projects showcasing end-to-end development skills
            </p>
          ...
          <section id="contact" className="py-20 text-center">
            ...
            <p className="text-gray-400 mb-12 max-w-2xl mx-auto">
              I&apos;m always interested in discussing data science projects, collaboration opportunities, or just connecting with fellow enthusiasts
            </p>
